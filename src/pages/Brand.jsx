...
const COPY = {
  ...
  ko: {
    ...
    stmtBody: '하지만 바쁜 일상 속에서 곡물은 어느새 불리고 삶는 번거로움에, 매일 챙겨 먹기 어려운 음식이 되어버렸습니다.',
    purposeEyebrow: '우리의 시작',
    purposeTitle: <>곡물:원은<br />그 고민에서 시작되었습니다.</>,
    purposeBody: '좋은 곡물을 더 쉽게 고르고, 더 편하게 먹고, 자연스럽게 매일의 습관이 되도록. 그것이 곡물:원이 믿는 방향입니다.',
    techAlt: '곡물:원 그레인케어 기술 — 곡물마다 가장 알맞은 식감과 풍미로 완성',
    techLabel: '그레인케어 기술',
    techTitle: <>곡물마다 연구하고,<br />정성으로 짓습니다.</>,
    techBody1: '곡물:원의 그레인케어 기술은 곡물 하나하나의 특성을 연구해, 저마다 가장 맛있는 식감과 풍미를 찾아냅니다. 곡물별 맞춤 침지와 고온·고압 쿠킹으로 영양은 지키고, 식감은 촉촉하고 부드럽게 완성합니다.',
    techBody2: '꼭꼭 씹어 먹는 진짜 식사의 든든함은 그대로, 뜯어서 바로 먹는 간편함을 더했습니다. 곡물:원이 제안하는 새로운 곡물 식문화입니다.',
    careEyebrow: '코리안 프리미엄 그레인 케어',
    careTitle: '간편식, 그 이상.',
    careBody: '곡물:원은 단순한 간편식이 아닙니다. 매일의 식사를 위해, 더 나은 영양을 위해 정성껏 설계한 코리안 프리미엄 그레인 케어입니다.',
    closeLabel: 'GOKMUL:ONE',
